...
import { throwIfAlreadyLoaded } from '@xplat-clean/utils';
import {
  CoreModule,
  PlatformLanguageToken,
  WindowPlatformService
} from '@xplat-clean/core';
...
export class BenCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: BenCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'BenCoreModule');
  }
}
